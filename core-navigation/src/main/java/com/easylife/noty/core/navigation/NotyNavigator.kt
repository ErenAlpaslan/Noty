...
abstract class NotyNavigator : Navigator() {
    ...
    suspend fun handleNavigationCommands(navController: NavController) {
        navigationCommands
            .onSubscription { this@NotyNavigator.navControllerFlow.value = navController }
            .onCompletion { this@NotyNavigator.navControllerFlow.value = null }
            .collect {
